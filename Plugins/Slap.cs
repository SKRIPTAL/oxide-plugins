...
namespace Oxide.Plugins
{
    ...
    class Slap : CovalencePlugin
    {
        ...
        void LoadDefaultMessages()
        {
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ["CommandUsage"] = "Utilisation : {0} <nom ou id> <montant> (montant est facultatif)",
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ["CommandUsage"] = "Verbrauch: {0} <name oder id> <betrag> (betrag ist optional)",
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ["CommandUsage"] = "Использование: {0} <имя или id> <сумма> (сумма необязательно)",
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ["CommandUsage"] = "Uso: {0} <nombre o id> <cantidad> (la cantidad es opcional)",
